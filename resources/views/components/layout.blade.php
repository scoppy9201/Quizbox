            ...
            <div id="mobile-menu"
                ...
                <ul class="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 w-full sm:w-auto">
                    <li><a href="{{ route('movies.index') }}"
                            class="btn btn-link w-full sm:w-auto text-left">Đề thi</a></li>
                    <li><a href="{{ route('shows.index') }}"
                            class="btn btn-link w-full sm:w-auto text-left">Môn học</a></li>
                </ul>
                ...
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-3 sm:ml-6 w-full sm:w-auto">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-link w-full sm:w-auto text-sm text-left">Đăng nhập</a>
                        <a href="{{ route('register') }}"
                            class="btn btn-link w-full sm:w-auto text-sm text-left">Đăng ký</a>
                    @endauth
                </div>
            </div>
        </nav>
